...
class Classifier(object):
    ...
    def build_train_validation_graph(self):
        ...
        if FLAGS.build_model == "build_model_normal":
            logits = inference_normal(self.image_placeholder, FLAGS.num_residual_blocks, False, list_weight,
                                      list_last_layer,
                                      list_ss)
            vali_logits = inference_normal(self.vali_image_placeholder, FLAGS.num_residual_blocks, True, list_weight,
                                           list_last_layer, list_ss)
        elif FLAGS.build_model == "build_model_FwSS":
            logits = inference_FwSS(self.image_placeholder, FLAGS.num_residual_blocks, False, list_weight,
                                    list_last_layer,
                                    list_ss)
            vali_logits = inference_FwSS(self.vali_image_placeholder, FLAGS.num_residual_blocks, True, list_weight,
                                         list_last_layer, list_ss)
        elif FLAGS.build_model == "build_model_FwSS_compare_1":
            logits = inference_FwSS_compare_1(self.image_placeholder, FLAGS.num_residual_blocks, False, list_weight,
                                              list_last_layer,
                                              list_ss)
            vali_logits = inference_FwSS_compare_1(self.vali_image_placeholder, FLAGS.num_residual_blocks, True,
                                                   list_weight,
                                                   list_last_layer, list_ss)
        elif FLAGS.build_model == "build_model_FwSS_compare_2":
            logits = inference_FwSS_compare_2(self.image_placeholder, FLAGS.num_residual_blocks, False, list_weight,
                                              list_last_layer,
                                              list_ss)
            vali_logits = inference_FwSS_compare_2(self.vali_image_placeholder, FLAGS.num_residual_blocks, True,
                                                   list_weight,
                                                   list_last_layer, list_ss)
        else:
